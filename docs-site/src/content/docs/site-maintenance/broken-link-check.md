---
title: "Broken Link 檢查"
description: "Broken Link 檢查：說明文件站本身的新增、更新、驗證與發布流程。"
audience:
  - human-maintainer
  - ai-agent
tags:
...
## 目的
Broken link validation process. 相關 repository、依賴或工作流程改變時，必須同步更新本頁。
