---
title: "Prompt 範本庫"
description: "Prompt 範本庫：提供 AI Agent 安全維護 Rancher 1.6 的操作契約。"
audience:
  - human-maintainer
  - ai-agent
tags:
...
## 目的
Copyable prompts for common maintenance tasks. 相關 repository、依賴或工作流程改變時，必須同步更新本頁。
