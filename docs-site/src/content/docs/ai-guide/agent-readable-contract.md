---
title: "AI Agent 可讀契約"
description: "AI Agent 可讀契約：提供 AI Agent 安全維護 Rancher 1.6 的操作契約。"
audience:
  - human-maintainer
  - ai-agent
tags:
...
## 目的
Machine-readable safety contract for AI changes. 相關 repository、依賴或工作流程改變時，必須同步更新本頁。
