---
title: "任務拆解範本"
description: "任務拆解範本：提供 AI Agent 安全維護 Rancher 1.6 的操作契約。"
audience:
  - human-maintainer
  - ai-agent
tags:
...
## 目的
Template for splitting risky maintenance work. 相關 repository、依賴或工作流程改變時，必須同步更新本頁。
