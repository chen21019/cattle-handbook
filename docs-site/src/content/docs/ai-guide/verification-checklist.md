---
title: "驗證檢查清單"
description: "驗證檢查清單：提供 AI Agent 安全維護 Rancher 1.6 的操作契約。"
audience:
  - human-maintainer
  - ai-agent
tags:
...
## 目的
Required final audit checklist for AI tasks. 相關 repository、依賴或工作流程改變時，必須同步更新本頁。
