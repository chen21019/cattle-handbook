---
title: "Cattle API 總覽"
description: "Cattle API 總覽：整理 Rancher 1.6 API 行為、相容性與檢查重點。"
audience:
  - human-maintainer
  - ai-agent
tags:
...
## 目的
Cattle API structure and compatibility policy. 相關 repository、依賴或工作流程改變時，必須同步更新本頁。
