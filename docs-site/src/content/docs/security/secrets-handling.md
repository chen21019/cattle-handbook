---
title: "Secrets 處理"
description: "Secrets 處理：說明 EOL 風險、安全分流、威脅模型與修補流程。"
audience:
  - human-maintainer
  - ai-agent
tags:
...
## 目的
Secrets storage, transport, and logging precautions. 相關 repository、依賴或工作流程改變時，必須同步更新本頁。
