---
title: "給人類維護者"
description: "給人類維護者：協助第一次接觸 Rancher 1.6 的維護者安全開始。"
audience:
  - human-maintainer
  - ai-agent
tags:
...
## 目的
A first-week learning path for engineers new to Rancher 1.6. 相關 repository、依賴或工作流程改變時，必須同步更新本頁。
