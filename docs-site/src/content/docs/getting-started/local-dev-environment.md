---
title: "本機開發環境"
description: "本機開發環境：協助第一次接觸 Rancher 1.6 的維護者安全開始。"
audience:
  - human-maintainer
  - ai-agent
tags:
...
## 目的
Documents Java, Go, Node, Docker, and OS assumptions. 相關 repository、依賴或工作流程改變時，必須同步更新本頁。
