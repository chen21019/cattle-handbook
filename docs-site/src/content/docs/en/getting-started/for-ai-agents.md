---
title: "For AI Agents"
description: "Entry contract and safe workflow for Codex CLI and AI maintainers."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Entry contract and safe workflow for Codex CLI and AI maintainers. It should be updated whenever the related repository, dependency, or workflow changes.
