...
description: "Documents Java, Go, Node, Docker, and OS assumptions."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Documents Java, Go, Node, Docker, and OS assumptions. It should be updated whenever the related repository, dependency, or workflow changes.
...
圖名：Local Dev Environment Flow
用途：把 Local Dev Environment 轉成可執行的維護流程。
