---
title: "First Build"
description: "Guides the first reproducible build attempt and evidence capture."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Guides the first reproducible build attempt and evidence capture. It should be updated whenever the related repository, dependency, or workflow changes.
