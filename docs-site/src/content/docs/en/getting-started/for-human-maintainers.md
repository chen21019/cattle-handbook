---
title: "For Human Maintainers"
description: "A first-week learning path for engineers new to Rancher 1.6."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
A first-week learning path for engineers new to Rancher 1.6. It should be updated whenever the related repository, dependency, or workflow changes.
...
圖名：For Human Maintainers Flow
用途：把 For Human Maintainers 轉成可執行的維護流程。
