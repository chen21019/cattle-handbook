...
description: "Maven and Java dependency inventory guidance."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Maven and Java dependency inventory guidance. It should be updated whenever the related repository, dependency, or workflow changes.
...
圖名：Java Dependencies Flow
用途：把 Java Dependencies 轉成可執行的維護流程。
