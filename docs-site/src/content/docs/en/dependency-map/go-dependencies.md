...
description: "Go, Glide, and GOPATH-era dependency guidance."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Go, Glide, and GOPATH-era dependency guidance. It should be updated whenever the related repository, dependency, or workflow changes.
...
圖名：Go Dependencies Flow
用途：把 Go Dependencies 轉成可執行的維護流程。
