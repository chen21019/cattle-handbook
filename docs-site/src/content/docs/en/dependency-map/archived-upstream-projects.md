---
title: "Archived Upstream Projects"
description: "Tracks repos and packages with inactive upstreams."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Tracks repos and packages with inactive upstreams. It should be updated whenever the related repository, dependency, or workflow changes.
...
圖名：Archived Upstream Projects Flow
用途：把 Archived Upstream Projects 轉成可執行的維護流程。
