...
description: "Node, npm, Bower, and UI dependency guidance."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Node, npm, Bower, and UI dependency guidance. It should be updated whenever the related repository, dependency, or workflow changes.
...
圖名：Node Dependencies Flow
用途：把 Node Dependencies 轉成可執行的維護流程。
