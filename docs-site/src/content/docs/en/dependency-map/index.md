...
description: "Dependency map entry point and maintenance rules."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Dependency map entry point and maintenance rules. It should be updated whenever the related repository, dependency, or workflow changes.
...
圖名：Dependency Map Flow
用途：把 Dependency Map 轉成可執行的維護流程。
