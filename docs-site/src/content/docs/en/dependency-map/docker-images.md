---
title: "Docker Images"
description: "Docker base image and runtime image inventory."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Docker base image and runtime image inventory. It should be updated whenever the related repository, dependency, or workflow changes.
...
圖名：Docker Images Flow
用途：把 Docker Images 轉成可執行的維護流程。
