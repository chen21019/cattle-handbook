...
description: "Notes for future framework or dependency migrations."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Notes for future framework or dependency migrations. It should be updated whenever the related repository, dependency, or workflow changes.
...
圖名：Migration Notes Flow
用途：把 Migration Notes 轉成可執行的維護流程。
