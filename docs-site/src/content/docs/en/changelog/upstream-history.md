...
description: "Timeline for upstream Rancher 1.6 behavior and fork notes."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Timeline for upstream Rancher 1.6 behavior and fork notes. It should be updated whenever the related repository, dependency, or workflow changes.
...
圖名：Upstream History Flow
用途：把 Upstream History 轉成可執行的維護流程。
