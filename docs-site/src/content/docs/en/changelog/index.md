---
title: "Changelog"
description: "Documentation changelog entry point."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Documentation changelog entry point. It should be updated whenever the related repository, dependency, or workflow changes.
