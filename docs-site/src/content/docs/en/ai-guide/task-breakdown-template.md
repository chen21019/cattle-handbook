...
description: "Template for splitting risky maintenance work."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Template for splitting risky maintenance work. It should be updated whenever the related repository, dependency, or workflow changes.
...
圖名：Task Breakdown Template Flow
用途：把 Task Breakdown Template 轉成可執行的維護流程。
