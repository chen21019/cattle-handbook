...
description: "Machine-readable safety contract for AI changes."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Machine-readable safety contract for AI changes. It should be updated whenever the related repository, dependency, or workflow changes.
...
圖名：Agent Readable Contract Flow
用途：把 Agent Readable Contract 轉成可執行的維護流程。
