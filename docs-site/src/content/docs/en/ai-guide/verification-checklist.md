...
description: "Required final audit checklist for AI tasks."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Required final audit checklist for AI tasks. It should be updated whenever the related repository, dependency, or workflow changes.
...
圖名：Verification Checklist Flow
用途：把 Verification Checklist 轉成可執行的維護流程。
