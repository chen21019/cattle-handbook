---
title: "AI Guide"
description: "AI agent entry point and operating contract."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
AI agent entry point and operating contract. It should be updated whenever the related repository, dependency, or workflow changes.
