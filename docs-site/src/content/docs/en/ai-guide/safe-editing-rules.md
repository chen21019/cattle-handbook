...
description: "Forbidden actions and required checks before code changes."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Forbidden actions and required checks before code changes. It should be updated whenever the related repository, dependency, or workflow changes.
