---
title: "Auth API"
description: "Auth API lifecycle and risk."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Auth API lifecycle and risk. It should be updated whenever the related repository, dependency, or workflow changes.
