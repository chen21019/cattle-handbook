---
title: "Cattle API Overview"
description: "Cattle API structure and compatibility policy."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Cattle API structure and compatibility policy. It should be updated whenever the related repository, dependency, or workflow changes.
...
圖名：Cattle API Overview Flow
用途：把 Cattle API Overview 轉成可執行的維護流程。
