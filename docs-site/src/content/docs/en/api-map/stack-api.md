---
title: "Stack API"
description: "Stack lifecycle and compose executor relationship."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Stack lifecycle and compose executor relationship. It should be updated whenever the related repository, dependency, or workflow changes.
