---
title: "Project API"
description: "Project model and compatibility notes."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Project model and compatibility notes. It should be updated whenever the related repository, dependency, or workflow changes.
