---
title: "Service API"
description: "Service lifecycle and event flow."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Service lifecycle and event flow. It should be updated whenever the related repository, dependency, or workflow changes.
