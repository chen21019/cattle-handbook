---
title: "Build Rancher Server"
description: "Build workflow for the server repo."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Build workflow for the server repo. It should be updated whenever the related repository, dependency, or workflow changes.
...
圖名：Build Rancher Server Flow
用途：把 Build Rancher Server 轉成可執行的維護流程。
