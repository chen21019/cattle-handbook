---
title: "Build UI"
description: "Build workflow for legacy UI assets."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Build workflow for legacy UI assets. It should be updated whenever the related repository, dependency, or workflow changes.
