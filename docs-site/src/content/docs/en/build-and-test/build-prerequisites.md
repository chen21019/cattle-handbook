...
description: "Required local tools and version strategy."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Required local tools and version strategy. It should be updated whenever the related repository, dependency, or workflow changes.
...
圖名：Build Prerequisites Flow
用途：把 Build Prerequisites 轉成可執行的維護流程。
