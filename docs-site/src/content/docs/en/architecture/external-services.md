...
description: "Lists service discovery, catalog, registries, cloud providers, and image dependencies."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Lists service discovery, catalog, registries, cloud providers, and image dependencies. It should be updated whenever the related repository, dependency, or workflow changes.
...
圖名：External Services Flow
用途：說明 External Services 在 Rancher 1.6 維護知識中的位置。
