...
description: "Explains host agent communication and upgrade constraints."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Explains host agent communication and upgrade constraints. It should be updated whenever the related repository, dependency, or workflow changes.
