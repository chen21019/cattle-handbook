...
description: "Documents the legacy UI stack and build risks."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Documents the legacy UI stack and build risks. It should be updated whenever the related repository, dependency, or workflow changes.
...
圖名：UI Architecture Flow
用途：說明 UI Architecture 在 Rancher 1.6 維護知識中的位置。
