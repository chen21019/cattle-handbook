...
description: "Explains schema migrations and rollback posture."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Explains schema migrations and rollback posture. It should be updated whenever the related repository, dependency, or workflow changes.
...
圖名：Database And Migrations Flow
用途：說明 Database And Migrations 在 Rancher 1.6 維護知識中的位置。
