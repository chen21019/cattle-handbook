---
title: "Networking"
description: "Maps rancher-net, DNS, metadata, and scheduler responsibilities."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Maps rancher-net, DNS, metadata, and scheduler responsibilities. It should be updated whenever the related repository, dependency, or workflow changes.
...
圖名：Networking Flow
用途：說明 Networking 在 Rancher 1.6 維護知識中的位置。
