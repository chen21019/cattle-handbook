---
title: "Rancher 1.6 Overview"
description: "High-level architecture of the legacy Cattle platform."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
High-level architecture of the legacy Cattle platform. It should be updated whenever the related repository, dependency, or workflow changes.
...
圖名：Rancher 1.6 Overview Flow
用途：說明 Rancher 1.6 Overview 在 Rancher 1.6 維護知識中的位置。
