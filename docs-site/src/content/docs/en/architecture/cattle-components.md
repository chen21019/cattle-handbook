---
title: "Cattle Components"
description: "Explains core Cattle modules and their responsibilities."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Explains core Cattle modules and their responsibilities. It should be updated whenever the related repository, dependency, or workflow changes.
...
圖名：Cattle Components Flow
用途：說明 Cattle Components 在 Rancher 1.6 維護知識中的位置。
