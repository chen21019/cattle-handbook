...
description: "Secrets storage, transport, and logging precautions."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Secrets storage, transport, and logging precautions. It should be updated whenever the related repository, dependency, or workflow changes.
...
圖名：Secrets Handling Flow
用途：把 Secrets Handling 轉成可執行的維護流程。
