---
title: "Threat Model"
description: "Threat model and isolation recommendations."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Threat model and isolation recommendations. It should be updated whenever the related repository, dependency, or workflow changes.
...
圖名：Threat Model Flow
用途：把 Threat Model 轉成可執行的維護流程。
