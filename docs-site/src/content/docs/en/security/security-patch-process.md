---
title: "Security Patch Process"
description: "Security patch workflow and disclosure notes."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Security patch workflow and disclosure notes. It should be updated whenever the related repository, dependency, or workflow changes.
...
圖名：Security Patch Process Flow
用途：把 Security Patch Process 轉成可執行的維護流程。
