...
description: "Branch naming, release tags, and hotfix structure."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Branch naming, release tags, and hotfix structure. It should be updated whenever the related repository, dependency, or workflow changes.
...
圖名：Branch Strategy Flow
用途：把 Branch Strategy 轉成可執行的維護流程。
