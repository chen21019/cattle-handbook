...
description: "Operational workflow for safe Rancher 1.6 patches."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Operational workflow for safe Rancher 1.6 patches. It should be updated whenever the related repository, dependency, or workflow changes.
