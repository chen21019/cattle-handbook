---
title: "Issue Triage"
description: "Bug source classification and prioritization."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Bug source classification and prioritization. It should be updated whenever the related repository, dependency, or workflow changes.
...
圖名：Issue Triage Flow
用途：把 Issue Triage 轉成可執行的維護流程。
