...
description: "Release readiness and rollback checklist."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Release readiness and rollback checklist. It should be updated whenever the related repository, dependency, or workflow changes.
...
圖名：Release Checklist Flow
用途：把 Release Checklist 轉成可執行的維護流程。
