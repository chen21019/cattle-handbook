...
description: "Legacy support policy and compatibility rules."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Legacy support policy and compatibility rules. It should be updated whenever the related repository, dependency, or workflow changes.
...
圖名：Maintenance Policy Flow
用途：把 Maintenance Policy 轉成可執行的維護流程。
