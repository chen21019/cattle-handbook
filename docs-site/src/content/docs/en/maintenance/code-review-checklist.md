...
description: "Review checklist for legacy compatibility."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Review checklist for legacy compatibility. It should be updated whenever the related repository, dependency, or workflow changes.
...
圖名：Code Review Checklist Flow
用途：把 Code Review Checklist 轉成可執行的維護流程。
