...
<div class="hero-grid">
  <div class="mascot-panel">
    ...
    <img src="/assets/cattle-chan-v2.png" alt="AI-generated original sakura maintenance heroine Cattle-chan" />
...
<div class="quick-grid">
  ...
  <div class="quick-card tone-coral"><span class="card-mark">CVE</span><strong>I am reviewing security risk</strong><br />Start with verified risk notes, threat models, and patch process.</div>
...
<form class="search-panel handbook-home-search" data-handbook-search data-search-mode="redirect" data-search-locale="en" action="/en/search/">
  <div class="panel-label">Find the right document before touching code</div>
  <input id="home-doc-search-en" name="q" type="search" aria-label="Search docs" placeholder="Search errors, dependencies, API behavior, runbooks, or AI tasks" />
  <button class="search-submit" type="submit">Search</button>
  <div class="search-status" data-search-status aria-live="polite"></div>
  <div class="search-chips">
    <button class="search-chip" type="button" data-search-query="Build failure">Build failure</button>
    <button class="search-chip" type="button" data-search-query="Dependency upgrade">Dependency upgrade</button>
    <button class="search-chip" type="button" data-search-query="CVE triage">CVE triage</button>
    <button class="search-chip" type="button" data-search-query="Agent compatibility">Agent compatibility</button>
    <button class="search-chip" type="button" data-search-query="API behavior">API behavior</button>
    <button class="search-chip" type="button" data-search-query="Release checklist">Release checklist</button>
  </div>
</form>
...
<div class="status-grid">
  ...
  <div class="status-card status-danger"><span>Verify</span><strong>Risk notes</strong><br />Show only sourced risks or clearly marked verification tasks.</div>
...
flowchart LR
  ...
  Handbook --> Security[Verified Risk Notes]
```
