...
description: "Ranking formula and metadata boosts."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Ranking formula and metadata boosts. It should be updated whenever the related repository, dependency, or workflow changes.
