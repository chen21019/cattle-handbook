---
title: "Search API"
description: "Hybrid search API request and response contract."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Hybrid search API request and response contract. It should be updated whenever the related repository, dependency, or workflow changes.
