...
description: "BM25 plus vector hybrid search design."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
BM25 plus vector hybrid search design. It should be updated whenever the related repository, dependency, or workflow changes.
