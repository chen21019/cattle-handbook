...
description: "Chunking and index build flow."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Chunking and index build flow. It should be updated whenever the related repository, dependency, or workflow changes.
