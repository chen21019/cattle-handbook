...
description: "Search index freshness and smoke test rules."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Search index freshness and smoke test rules. It should be updated whenever the related repository, dependency, or workflow changes.
