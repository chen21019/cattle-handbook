---
title: "Vector Search"
description: "Vector search design and future database options."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Vector search design and future database options. It should be updated whenever the related repository, dependency, or workflow changes.
