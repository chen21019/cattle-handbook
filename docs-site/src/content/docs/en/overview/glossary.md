---
title: "Glossary"
description: "Explains Cattle, stack, service, host, agent, metadata, and legacy terms."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Explains Cattle, stack, service, host, agent, metadata, and legacy terms. It should be updated whenever the related repository, dependency, or workflow changes.
