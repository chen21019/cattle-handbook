...
description: "Preserves original license and attribution expectations."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Preserves original license and attribution expectations. It should be updated whenever the related repository, dependency, or workflow changes.
...
圖名：Legal And License Flow
用途：把 Legal And License 轉成可執行的維護流程。
