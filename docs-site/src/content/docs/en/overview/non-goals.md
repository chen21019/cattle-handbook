---
title: "Non Goals"
description: "Clarifies what this legacy handbook does not promise."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Clarifies what this legacy handbook does not promise. It should be updated whenever the related repository, dependency, or workflow changes.
