...
description: "Style rules for clear human and AI-readable docs."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Style rules for clear human and AI-readable docs. It should be updated whenever the related repository, dependency, or workflow changes.
...
圖名：Content Style Guide Flow
用途：把 Content Style Guide 轉成可執行的維護流程。
