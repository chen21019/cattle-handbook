...
description: "Mermaid and figure caption requirements."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Mermaid and figure caption requirements. It should be updated whenever the related repository, dependency, or workflow changes.
...
圖名：Diagram Guidelines Flow
用途：把 Diagram Guidelines 轉成可執行的維護流程。
