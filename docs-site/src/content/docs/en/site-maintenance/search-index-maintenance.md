---
title: "Search Index Maintenance"
description: "How to rebuild and verify search indexes."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
How to rebuild and verify search indexes. It should be updated whenever the related repository, dependency, or workflow changes.
...
圖名：Search Index Maintenance Flow
用途：把 Search Index Maintenance 轉成可執行的維護流程。
