...
description: "Navigation and section ownership rules."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Navigation and section ownership rules. It should be updated whenever the related repository, dependency, or workflow changes.
...
圖名：Information Architecture Flow
用途：把 Information Architecture 轉成可執行的維護流程。
