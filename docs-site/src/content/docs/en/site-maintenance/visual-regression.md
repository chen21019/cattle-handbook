...
description: "Frontend regression and screenshot review process."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Frontend regression and screenshot review process. It should be updated whenever the related repository, dependency, or workflow changes.
...
圖名：Visual Regression Flow
用途：把 Visual Regression 轉成可執行的維護流程。
