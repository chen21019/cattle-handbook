...
description: "Site maintenance entry point."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Site maintenance entry point. It should be updated whenever the related repository, dependency, or workflow changes.
...
圖名：Site Maintenance Flow
用途：把 Site Maintenance 轉成可執行的維護流程。
