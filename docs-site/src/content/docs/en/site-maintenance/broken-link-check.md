...
description: "Broken link validation process."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Broken link validation process. It should be updated whenever the related repository, dependency, or workflow changes.
...
圖名：Broken Link Check Flow
用途：把 Broken Link Check 轉成可執行的維護流程。
