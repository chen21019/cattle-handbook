---
title: "AI Maintained Docs Workflow"
description: "AI workflow for maintaining this site."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
AI workflow for maintaining this site. It should be updated whenever the related repository, dependency, or workflow changes.
...
圖名：AI Maintained Docs Workflow Flow
用途：把 AI Maintained Docs Workflow 轉成可執行的維護流程。
