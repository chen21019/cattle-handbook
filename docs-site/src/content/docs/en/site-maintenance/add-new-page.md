---
title: "Add New Page"
description: "Workflow for adding a page."
audience:
  - human-maintainer
  - ai-agent
tags:
...
## Purpose
Workflow for adding a page. It should be updated whenever the related repository, dependency, or workflow changes.
...
圖名：Add New Page Flow
用途：把 Add New Page 轉成可執行的維護流程。
