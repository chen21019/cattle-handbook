---
title: "Cattle 元件"
description: "Cattle 元件：整理 Rancher 1.6 / Cattle 的元件關係與架構脈絡。"
audience:
  - human-maintainer
  - ai-agent
tags:
...
## 目的
Explains core Cattle modules and their responsibilities. 相關 repository、依賴或工作流程改變時，必須同步更新本頁。
