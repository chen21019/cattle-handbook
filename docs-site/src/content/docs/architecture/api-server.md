---
title: "API 伺服器"
description: "API 伺服器：整理 Rancher 1.6 / Cattle 的元件關係與架構脈絡。"
audience:
  - human-maintainer
  - ai-agent
tags:
...
## 目的
Describes API server request handling and compatibility risk. 相關 儲存庫、依賴或工作流程改變時，必須同步更新本頁。
...
圖名：API 伺服器 流程
用途：說明 API 伺服器 在 Rancher 1.6 維護知識中的位置。
