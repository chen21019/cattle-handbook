---
title: "認證與授權"
description: "認證與授權：整理 Rancher 1.6 / Cattle 的元件關係與架構脈絡。"
audience:
  - human-maintainer
  - ai-agent
tags:
...
## 目的
Documents auth-service and local/external auth risk. 相關 repository、依賴或工作流程改變時，必須同步更新本頁。
...
圖名：Authentication And Authorization 流程
