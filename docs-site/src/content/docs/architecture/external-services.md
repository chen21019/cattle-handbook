---
title: "外部服務"
description: "外部服務：整理 Rancher 1.6 / Cattle 的元件關係與架構脈絡。"
audience:
  - human-maintainer
  - ai-agent
tags:
...
## 目的
Lists service discovery, catalog, registries, cloud providers, and image dependencies. 相關 儲存庫、依賴或工作流程改變時，必須同步更新本頁。
