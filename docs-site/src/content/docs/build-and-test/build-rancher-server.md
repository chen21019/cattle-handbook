---
title: "建置 Rancher Server"
description: "建置 Rancher Server：整理建置、測試、CI 與可重現驗證流程。"
audience:
  - human-maintainer
  - ai-agent
tags:
...
## 目的
Build workflow for the server repo. 相關 repository、依賴或工作流程改變時，必須同步更新本頁。
