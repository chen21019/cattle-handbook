---
title: "維護政策"
description: "維護政策：定義 legacy 維護、patch、review 與 release 流程。"
audience:
  - human-maintainer
  - ai-agent
tags:
...
## 目的
Legacy support policy and compatibility rules. 相關 repository、依賴或工作流程改變時，必須同步更新本頁。
