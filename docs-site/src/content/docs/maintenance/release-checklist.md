---
title: "Release 檢查清單"
description: "Release 檢查清單：定義 legacy 維護、patch、review 與 release 流程。"
audience:
  - human-maintainer
  - ai-agent
tags:
...
## 目的
Release readiness and rollback checklist. 相關 repository、依賴或工作流程改變時，必須同步更新本頁。
