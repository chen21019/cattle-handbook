---
title: "Branch 策略"
description: "Branch 策略：定義 legacy 維護、patch、review 與 release 流程。"
audience:
  - human-maintainer
  - ai-agent
tags:
...
## 目的
Branch naming, release tags, and hotfix structure. 相關 repository、依賴或工作流程改變時，必須同步更新本頁。
