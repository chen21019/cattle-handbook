---
title: "上游歷史"
description: "上游歷史：記錄維護歷史、migration notes 與上游對照。"
audience:
  - human-maintainer
  - ai-agent
tags:
...
## 目的
Timeline for upstream Rancher 1.6 behavior and fork notes. 相關 repository、依賴或工作流程改變時，必須同步更新本頁。
