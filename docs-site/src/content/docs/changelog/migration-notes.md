...
description: "Migration Notes：記錄維護歷史、migration notes 與上游對照。"
audience:
  - human-maintainer
  - ai-agent
tags:
...
## 目的
Notes for future framework or dependency migrations. 相關 repository、依賴或工作流程改變時，必須同步更新本頁。
