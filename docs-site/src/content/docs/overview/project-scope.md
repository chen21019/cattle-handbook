---
title: "專案範圍"
description: "專案範圍：說明 Rancher 1.6 維護手冊的定位、邊界與閱讀起點。"
audience:
  - human-maintainer
  - ai-agent
tags:
...
## 目的
Maps which Rancher 1.6 forks and maintenance surfaces belong in scope. 相關 repository、依賴或工作流程改變時，必須同步更新本頁。
