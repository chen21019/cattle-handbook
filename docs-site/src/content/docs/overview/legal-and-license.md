---
title: "法律與授權"
description: "法律與授權：說明 Rancher 1.6 維護手冊的定位、邊界與閱讀起點。"
audience:
  - human-maintainer
  - ai-agent
tags:
...
## 目的
Preserves original license and attribution expectations. 相關 repository、依賴或工作流程改變時，必須同步更新本頁。
