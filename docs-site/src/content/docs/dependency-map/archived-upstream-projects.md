---
title: "已封存的上游專案"
description: "已封存的上游專案：記錄依賴、風險、升級限制與驗證方式。"
audience:
  - human-maintainer
  - ai-agent
tags:
...
## 目的
Tracks repos and packages with inactive upstreams. 相關 repository、依賴或工作流程改變時，必須同步更新本頁。
...
圖名：Archived Upstream Projects 流程
